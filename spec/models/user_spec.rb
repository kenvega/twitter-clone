...
RSpec.describe User, type: :model do
  ...
  it { should have_many(:viewable_tweet_activities).with_foreign_key(:activity_viewer_id).class_name("TweetActivity").dependent(:destroy) }
  it { should have_many(:created_tweet_activities).with_foreign_key(:activity_creator_id).class_name("TweetActivity").dependent(:destroy) }
